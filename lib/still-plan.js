...
export const IDENTITY_STILL_REQUIRES_FAL = "IDENTITY_STILL_REQUIRES_FAL"
export const IDENTITY_STILL_MODEL_MISMATCH = "IDENTITY_STILL_MODEL_MISMATCH"
...
export function planSceneStill(scene, characters) {
  ...
  return {
    ...
    references,
    providerRoute: providerRouteForCount(onScreen.length),
    stillRoute: stillRouteForCount(onScreen.length),
    ready,
    blockReason,
