...
import { inspectRailReadiness, resolveContentRail, withEffectiveImageRail } from "@/lib/content-rails"
...
export async function loadSeriesRail(seriesId) {
  ...
  const base = resolveContentRail(series.contentRating)
  const rail = withEffectiveImageRail(base)
