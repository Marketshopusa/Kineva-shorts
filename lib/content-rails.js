...
export const CONTENT_RATINGS = [
  {
    ...
    voiceProvider: "edge",
    blocked: ["leonardo", "elevenlabs", "veo", "runway", "luma", "kling"],
  },
  {
    id: "mature",
    label: "Maduro (+18)",
    ...
    videoProvider: "remotion",
    voiceProvider: "edge",
    blocked: ["leonardo", "gemini", "elevenlabs", "veo", "runway", "luma", "kling"],
  },
  {
    id: "explicit",
    label: "Explícito (+18)",
    ...
    videoProvider: "remotion",
    voiceProvider: "edge",
    blocked: ["leonardo", "gemini", "elevenlabs", "veo", "runway", "luma", "kling", "anthropic"],
  },
]
